...
# Use semicolon-separated SHEETS environment variable (e.g. "Sheet1;Feb 7 2023 Onwards")
...
# -----------------------------------------------------------------
# Function: today_ist_long
# Purpose : General utility/helper function.
# -----------------------------------------------------------------
def today_ist_long():
...
# -----------------------------------------------------------------
# Function: normalize_list_from_csv
# Purpose : General utility/helper function.
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# Function: try_ddgs_images
# Purpose : Handle image download, caching, or deletion.
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# Function: download_image_to
# Purpose : Download data (Excel/Drive/JSON) or images required for the run.
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# Function: search_cover_image_queries
# Purpose : Handle image download, caching, or deletion.
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# Function: extract_duration_minutes
# Purpose : General utility/helper function.
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# Function: parse_synopsis_from_html
# Purpose : General utility/helper function.
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# Function: fetch_synopsis_and_duration
# Purpose : General utility/helper function.
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# Function: sheet_base_offset
# Purpose : Process Excel sheet contents into structured data.
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# Function: concise_update_message
# Purpose : Update dataset, JSON, or images with new/modified records.
# -----------------------------------------------------------------
...
# Purpose : Delete old/unneeded files (cleanup process).
# -----------------------------------------------------------------
...
# Purpose : Generate or append to reports/logs describing the run.
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# Function: update_json_from_excel
# Purpose : Update dataset, JSON, or images with new/modified records.
# -----------------------------------------------------------------
